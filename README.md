...
# debian-iso-builder-remix-spectrwm
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-remix-spectrwm/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-remix-spectrwm/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-remix-spectrwm/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-remix-spectrwm](https://github.com/samwhelp/debian-iso-builder-remix-spectrwm)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-remix-spectrwm.git
```


> change dir to `debian-iso-builder-remix-spectrwm`

``` sh
cd debian-iso-builder-remix-spectrwm
```
...
> change dir to `~/work/debian-iso-builder-remix-spectrwm/iso-profile`

``` sh
cd ~/work/debian-iso-builder-remix-spectrwm/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/debian-iso-builder-remix-spectrwm/iso-profile/dist`
...
| [debian-iso-builder-remix-kde-plasma](https://github.com/samwhelp/debian-iso-builder-remix-kde-plasma) | [debian-iso-builder-respin-kde-plasma](https://github.com/samwhelp/debian-iso-builder-respin-kde-xfce) |
| [debian-iso-builder-remix-xfce](https://github.com/samwhelp/debian-iso-builder-remix-xfce) | [debian-iso-builder-respin-xfce](https://github.com/samwhelp/debian-iso-builder-respin-spectrwm) |
